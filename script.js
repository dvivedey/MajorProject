...
// JavaScript for Gallery Animation
...
images.forEach(image => {
  totalWidth += image.clientWidth + parseInt(window.getComputedStyle(image).marginRight);
});

// Duplicate images to loop the animation
const cloneGallery = gallery.cloneNode(true);
gallery.parentNode.insertBefore(cloneGallery, gallery.nextSibling);

// Adjust gallery width to accommodate duplicated images
gallery.style.width = totalWidth * 2 + 'px';
cloneGallery.style.width = totalWidth * 2 + 'px';
